...
export default class extends Controller {
  ...
  validateQuantities() {
    const breakfast = this.generateFloatingNumber(this.breakfastTarget.value);
    const firstCollation = this.generateFloatingNumber(this.firstCollationTarget.value);
    const meal = this.generateFloatingNumber(this.mealTarget.value);
    const secondCollation = this.generateFloatingNumber(this.secondCollationTarget.value);
    const dinner = this.generateFloatingNumber(this.dinnerTarget.value);
