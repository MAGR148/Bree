...
ActiveRecord::Schema.define(version: 20_211_004_052_349) do
  ...
  create_table 'group_portion_times', force: :cascade do |t|
    ...
    t.jsonb 'vegetables',
            default: { 'meal' => 0, 'dinner' => 0, 'quantity' => 0, 'breakfast' => 0, 'first_collation' => 0, 'second_collation' => 0 }, null: false
    t.jsonb 'fruit',
            default: { 'meal' => 0, 'dinner' => 0, 'quantity' => 0, 'breakfast' => 0, 'first_collation' => 0, 'second_collation' => 0 }, null: false
    t.jsonb 'cereals_s_g',
            default: { 'meal' => 0, 'dinner' => 0, 'quantity' => 0, 'breakfast' => 0, 'first_collation' => 0, 'second_collation' => 0 }, null: false
  ...
  create_table 'group_portions', force: :cascade do |t|
    t.bigint 'plan_id', null: false
    t.jsonb 'vegetables', default: { 'energy' => 25, 'lipids' => 0, 'protein' => 2, 'quantity' => 0, 'carbohydrates' => 4 },
                          null: false
    t.jsonb 'fruit',
            default: { 'energy' => 60, 'lipids' => 0, 'protein' => 0, 'quantity' => 0, 'carbohydrates' => 15 }, null: false
    t.jsonb 'cereals_s_g', default: { 'energy' => 70, 'lipids' => 0, 'protein' => 2, 'quantity' => 0, 'carbohydrates' => 15 },
                           null: false
    t.jsonb 'cereals_c_g', default: { 'energy' => 115, 'lipids' => 5, 'protein' => 2, 'quantity' => 0, 'carbohydrates' => 15 },
                           null: false
    t.jsonb 'legumes', default: { 'energy' => 120, 'lipids' => 1, 'protein' => 8, 'quantity' => 0, 'carbohydrates' => 20 },
                       null: false
    t.jsonb 'aoa_mbag', default: { 'energy' => 40, 'lipids' => 1, 'protein' => 7, 'quantity' => 0, 'carbohydrates' => 0 },
                        null: false
    t.jsonb 'aoa_bag', default: { 'energy' => 55, 'lipids' => 3, 'protein' => 7, 'quantity' => 0, 'carbohydrates' => 0 },
                       null: false
    t.jsonb 'aoa_mag', default: { 'energy' => 75, 'lipids' => 5, 'protein' => 7, 'quantity' => 0, 'carbohydrates' => 0 },
                       null: false
    t.jsonb 'aoa_aag', default: { 'energy' => 100, 'lipids' => 8, 'protein' => 7, 'quantity' => 0, 'carbohydrates' => 0 },
                       null: false
    t.jsonb 'skim_milk', default: { 'energy' => 95, 'lipids' => 2, 'protein' => 9, 'quantity' => 0, 'carbohydrates' => 12 },
                         null: false
    t.jsonb 'semi_milk', default: { 'energy' => 110, 'lipids' => 4, 'protein' => 9, 'quantity' => 0, 'carbohydrates' => 12 },
                         null: false
    t.jsonb 'whole_milk', default: { 'energy' => 150, 'lipids' => 8, 'protein' => 9, 'quantity' => 0, 'carbohydrates' => 12 },
                          null: false
    t.jsonb 'milk_c_a', default: { 'energy' => 200, 'lipids' => 5, 'protein' => 8, 'quantity' => 0, 'carbohydrates' => 30 },
                        null: false
    t.jsonb 'fats_s_p', default: { 'energy' => 45, 'lipids' => 5, 'protein' => 0, 'quantity' => 0, 'carbohydrates' => 0 },
                        null: false
    t.jsonb 'fats_c_p', default: { 'energy' => 70, 'lipids' => 5, 'protein' => 3, 'quantity' => 0, 'carbohydrates' => 3 },
                        null: false
    t.jsonb 'sugars_s_g', default: { 'energy' => 40, 'lipids' => 0, 'protein' => 0, 'quantity' => 0, 'carbohydrates' => 10 },
                          null: false
    t.jsonb 'sugars_c_g', default: { 'energy' => 85, 'lipids' => 5, 'protein' => 0, 'quantity' => 0, 'carbohydrates' => 10 },
                          null: false
    t.jsonb 'ale', default: { 'energy' => 0, 'lipids' => 0, 'protein' => 0, 'quantity' => 0, 'carbohydrates' => 0 },
                   null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
